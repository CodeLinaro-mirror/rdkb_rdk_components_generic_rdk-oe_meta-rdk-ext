...
# Tip of the branch on May 23, 2024
SRCREV = "44cb95d724470c1180d1f4942d49a0d3154a734e"
...
SRC_URI += "file://2.38.5/1338.patch"
SRC_URI += "file://2.38.5/1339.patch"
SRC_URI += "file://2.38.5/1346.patch"
SRC_URI += "file://2.38.5/1352.patch"
SRC_URI += "file://2.38.5/1355.patch"
SRC_URI += "file://2.38.5/1356.patch"
SRC_URI += "file://2.38.5/1359.patch"

# Comcast specific changes
SRC_URI += "file://2.38.5/comcast-DELIA-60920-Malloc-Heap-Breakdown.patch"
...
SRC_URI += "file://2.38.5/comcast-DELIA-57933-Increase-minor-version-or-WPE-lib.patch"
...
PACKAGECONFIG_append = " webcrypto webdriver remoteinspector releaselog accessibility speechsynthesis native_video webaudio instantratechange serviceworker woff2"
...
PACKAGECONFIG_append_aarch64 = " webassembly"
...
PACKAGES =+ "${PN}-wpe-webdriver"
FILES_${PN}-wpe-webdriver += "${bindir}/WPEWebDriver"
INSANE_SKIP_${PN}-wpe-webdriver += "file-rdeps"

...
DEPENDS_append = " atk tts libepoxy libgcrypt rdkat rsync-native libsoup-2.4"
RDEPENDS_${PN} += "wpe-backend-rdk-platform-plugin tts rdkat"
DEPENDS_remove_daisy = " rsync-native"

inherit gettext

#Commits on April 26, 2022
SRCREV = "55b51e9b8c7a2cc7030e6f984fa317f3bf1bdc41"
...
SRC_URI += "file://2.22.4/0019-comcast-EME-add-SVP-support.patch"
...
SRC_URI += "file://2.22.4/0024-comcast-add-EAC3-support.patch"
...
SRC_URI += "file://2.22.4/0036-Enable-HEVC-support-in-OpenCDM-decryptor.patch"
...
SRC_URI += "file://2.22.6/0187-XRE-15546-RDM-RWI-WI-starts-working-only-after-resta.patch"
...
SRC_URI += "file://2.22.6/0291-increase-micro-version-version-to-match-recipe.patch"

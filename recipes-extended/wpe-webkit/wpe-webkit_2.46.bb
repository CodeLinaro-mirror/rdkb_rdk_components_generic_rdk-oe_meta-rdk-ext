...
CONFLICT_DISTRO_FEATURES = "wpe-2.28 wpe-2.38"
...
DEPENDS_append = " libtasn1 unifdef-native libsoup libepoxy libgcrypt"
RDEPENDS_${PN} += "wpe-backend-rdk-platform-plugin gstreamer1.0-plugins-good-matroska"
...
PACKAGECONFIG_append = " webdriver remoteinspector releaselog accessibility speechsynthesis native_video webaudio woff2 externalholepunch"
...
TUNE_CCARGS_remove = "${@bb.utils.contains('DISTRO_FEATURES', 'wpe-webkit-debugfission', '','-fno-omit-frame-pointer -fno-optimize-sibling-calls', d)}"

...
inherit meson pkgconfig systemd gettext useradd multilib_header
...
PACKAGECONFIG:class-target ??= " \
    ...
    ${FFMPEG_AVAILABLE} avahi flatpak gstreamer gsettings jack libusb pw-cat raop sndfile v4l2 udev volume libcamera readline pipewire-alsa \
"
...
PACKAGECONFIG[alsa] = "-Dalsa=enabled,,alsa-lib udev,,${MLPREFIX}pipewire-alsa ${MLPREFIX}pipewire-alsa-card-profile"
...
"
PACKAGECONFIG_remove = "libcamera"
...
FILES:${PN} = " \
    ...
    ${bindir}/pipewire \
    ${bindir}/pipewire-avb \
    ${includedir}/pipewire/pipewire.h \
    ${includedir}/pipewire/stream.h \
    ${includedir}/spa/param/audio/format-utils.h \
    ${includedir}/spa/utils/result.h \
    ${includedir}/spa/pod/iter.h \
    ${includedir}/spa/debug/types.h \
    ${includedir}/spa/utils/json.h \
    ${includedir}/spa/utils/ansi.h \
    ${includedir}/spa/utils/string.h \
"
...
do_install_append() {
    install -d ${D}${includedir}/pipewire
    install -d ${D}${includedir}/spa/param/audio
    install -d ${D}${includedir}/spa/utils
    install -d ${D}${includedir}/spa/pod
    install -d ${D}${includedir}/spa/debug
    install -m 0755 ${S}/src/pipewire/pipewire.h ${D}${includedir}/pipewire/
    install -m 0755 ${S}/src/pipewire/stream.h ${D}${includedir}/pipewire/
    install -m 0755 ${S}/spa/include/spa/utils/result.h ${D}${includedir}/spa/utils/
    install -m 0755 ${S}/spa/include/spa/utils/json.h ${D}${includedir}/spa/utils/
    install -m 0755 ${S}/spa/include/spa/utils/ansi.h ${D}${includedir}/spa/utils/
    install -m 0755 ${S}/spa/include/spa/utils/string.h ${D}${includedir}/spa/utils/
    install -m 0755 ${S}/spa/include/spa/utils/string.h ${D}${includedir}/spa/utils/
    install -m 0755 ${S}/spa/include/spa/debug/types.h ${D}${includedir}/spa/debug/
}
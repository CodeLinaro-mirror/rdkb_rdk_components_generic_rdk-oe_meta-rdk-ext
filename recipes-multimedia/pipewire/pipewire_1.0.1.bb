...
S = "${WORKDIR}/git"
inherit pkgconfig systemd gettext useradd
USERADD_PACKAGES = "${PN}"
...
CFLAGS_append = " -Wno-typedef-redefinition"
...
SYSTEMD_SERVICE_${PN} = "${@bb.utils.contains('PACKAGECONFIG', 'systemd-system-service', 'pipewire.service', '', d)}"
...
CONFFILES_${PN}-modules-rt = "${datadir}/pipewire/client-rt.conf"
FILES_${PN}-modules-rt += " \

...
#FILESPATH = "${FILE_DIRNAME}/gstreamer1.0"
...
SRC_URI = "https://gstreamer.freedesktop.org/src/gstreamer/gstreamer-${PV}.tar.xz \
           ...
           file://0009-SERXIONE-5687-gstpad-Avoid-race-in-un-setting-EOS-flag-on-sinkpads.patch \
           "
...
#EXTRA_OECONF += " \
#    ${@bb.utils.contains('TARGET_FPU', 'hard', '-mfloat-abi=hard', '', d)} \
#"

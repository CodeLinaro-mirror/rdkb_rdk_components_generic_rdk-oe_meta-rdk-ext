...
HOMEPAGE = "https://ftp.osuosl.org/pub/blfs/conglomeration/xfsprogs/"
...
SRC_URI = "https://ftp.osuosl.org/pub/blfs/conglomeration/xfsprogs/${P}.tar.gz \
...
# The <ustat.h> and <sys/ustat.h> have been removed from glibc-2.28, which fails xfsprogs.
# As dunfell default glibc version is 2.31, brought required changes to fix the failure from upstream xfsprofs in 0001-libxfs-linux.c-Replace-use-of-ustat-by-stat.patch.
SRC_URI_append_dunfell  = " file://0001-libxfs-linux.c-Replace-use-of-ustat-by-stat.patch"
